...
<body>
<div class ="loginform">
    <h2 style="color: black ;"><u> Adding New Villa</u></h2><br>
...
<?php
        ...
        if($con){
                if(isset($_POST["submit"])){
                    ...
                    $sql= "INSERT INTO `villas`(`Type`, `Total_Villas`, available, reserved, `Capacity`, `Rate`, `image`, `detail`) VALUES ('$type','$totalvillas','$totalvillas', 0, '$capacity','$rate', '$fileNameNew', '$details')";
                    ...
                    if($res){
                        ?>
                                        ...
                                        <?php
                                        header("Location: /RMS/html-php/admin-villa.php");
                    }
                    else{
                        ?>
                                            <script>
