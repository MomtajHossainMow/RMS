...
-->         <input class="btn btn-dark m-2" type="submit" name="checkbutton" value="Check Availability">
    ...
    // checkbutton- codes here
        ...
        if($con){
                    ...
                    if($diff->format("%r")== "-"){ // if the check out date is selected wrong
                        ...
                        if($typeaccomodation== "Room"){
                            ...
                            <script>
                                ...
                                header("Location: /RMS/html-php/booking.php");
                            </script>
                        <?php
                        }
                                    ...
                                    if($availablecheck >= 1 || $availablecheck >= 'Yes' ){
                                            ...
                                            <div class="container">
                                                <form action="booknow.php" method="POST">
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <?php $sourceimage= "/RMS/html-php/uploads/$src"; ?>
            ...
            if(isset($_POST["okbooknow"])){
                ...
                ?>
                <script>
                header("Location: /RMS/html-php/bo.php");/////////////////////////////////////////////////////////////////////////////////////////////////
                alert("Hi there!");
                </script> 
                <?php
            }
    ...
    <script>
        function mylang(data){
            ...
            ajaxreq.open('GET', 'http://localhost/RMS/html-php/getdata.php?selectvalue=' +data, 'TRUE' );
            ajaxreq.send();
