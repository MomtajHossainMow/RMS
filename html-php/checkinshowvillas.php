        ...
        <ul>
            ...
            <li><a href="#">Reservations</a>
                <ul>
                    ...
                    <li><a href="/RMS/html-php/reservedmeeting.php">Reserved Meeting Rooms & Halls</a></li>
...
<div class="list">
    ...
    <table>
        ...
        $selectquery = "select * from checkin where accomodationtype= 'Villa' and bookingstatus= 'CheckedIn'";
        ...
        ?>
           <tr>
            ...
            <td><a href='checkoutvillas.php?idno=<?php echo $res['bookingid']?>' onclick= 'return checkdelete()' >Check Out</a></td>
           </tr>
        <?php
        }
        ?>
