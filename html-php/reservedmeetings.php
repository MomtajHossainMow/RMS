...
<div class="list">
    <div>
        <h1>Reserved Meeting Rooms & Halls<button style=" font-family: times;"  class="rightalign" input type=button onClick="location.href='checkinshowmeetings.php'"
 value='click here'><b>Show Checked In Rooms</b></button></h1>
    ...
    <table>
        ...
        $selectquery = "select * from booking where accomodationtype= 'Meeting'";
        ...
        ?>
           <tr>
            ...
            <td><a href='docheckinmeeting.php?idno=<?php echo $res['bookingid']?>' >Check In</a></td>
            <td><a href='deletereservedmeetings.php?idno=<?php echo $res['bookingid']?>' onclick= 'return checkdelete()' >Delete</a></td>
           </tr>
        <?php
        }
        ?>
