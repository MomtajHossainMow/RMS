...
<div class="list">
    <div>
        <h1>Checked In Meeting Rooms and Halls</h1>
    </div>
    <table>
        <thead>
            <tr>
        ...
        $selectquery = "select * from checkin where accomodationtype= 'Meeting' and bookingstatus= 'CheckedIn'";
        ...
        ?>
           <tr>
            ...
            <td><a href='checkoutmeetings.php?idno=<?php echo $res['bookingid']?>' onclick= 'return checkdelete()' >Check Out</a></td>
           </tr>
        <?php
        }
        ?>
