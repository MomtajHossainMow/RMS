...
<div class="list">
    <div>
        <h1>Reserved Villas<button  style=" font-family: times;" class="rightalign" input type=button onClick="location.href='checkinshowvillas.php'"
 value='click here'><b>Show Checked In Villas</b></button></h1>
    </div>
    <table>
        <thead>
            <tr>
        ...
        $selectquery = "select * from booking where accomodationtype= 'Villa'";
        ...
        ?>
           <tr>
            ...
            <td><a href='docheckinvilla.php?idno=<?php echo $res['bookingid']?>' >Check In</a></td>
            <td><a href='deletereservedvillas.php?idno=<?php echo $res['bookingid']?>' onclick= 'return checkdelete()' >Delete</a></td>
           </tr>
        <?php
        }
        ?>
